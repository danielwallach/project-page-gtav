...
Obejtivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir uma caixa com os botões de seleção de plataforma
...
Objetivo 2 - caso a lista de botões de plataforma já esteja aparecendo e o usuario clicar em cima do botão, o conteúdo deve ser escondido
